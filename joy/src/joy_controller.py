    ...
    def __init__(self):
        ...
        for tries in range(0, 3):
            try:
                ...
                self.dynamic_client = dynamic_reconfigure.client.Client("idmind_motors", timeout=10, config_callback=self.update_params)
                break
            except Exception:
                if tries == 2:
        ...
        self.joy = rospy.get_param("idmind_teleop/key_mapping")
        ...
        #  Navigation  #
        ################
        teleop_topic = rospy.get_param("~cmd_vel_topic", "idmind_teleop/set_velocities")
        self.twist = Twist()
        self.last_joy = Joy()
